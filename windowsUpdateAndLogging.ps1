...
$EmailReport = $true
$FileReport = $true
#$To = "Patching@tailte.ie"
#$To = "kevin.russell@tailte.ie"
$To = "SanServerTeamDG@tailte.ie"
$From = "windowsUpdatepowershell@tailte.ie"
$SMTPServer = "smpt.osi.net"
$FileReportPath = "C:\Patching\"
$AutoRestart = $true
...
#Checkin with windows server update services
Invoke-Command { wuauclt.exe /detectnow }
Invoke-Command { wuauclt.exe /reportnow }
